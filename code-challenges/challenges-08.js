...
const customerAndAge = (obj) => {
  ...
  let arr = []
    for (const key in obj) {
        let customers = `Customer Name :${key} , Age :${obj[key]}`
        arr.push(customers)
    }
    return arr
};
...
const getInfo = (arr) => {
  ...
  for (let i = 0 ; i < arr.length ; i++ ){
        ...
        let arrstudant = (arr[i].Students).join(" ")
        studentsName.push(arrstudant)
  }
...
//   for (let i = 0 ; i < arr.length ; i++ ){
//     if(arr[i].Students === )
//     let studentCourse = arr[i].Course
//     let studentsName = 
//   }
//   return {}
  };
